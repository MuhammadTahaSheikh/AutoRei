...
function EmailSettings() {
  ...
  useEffect(() => {
    if (selectedTemplate === null) {
      ...
      setFormData({
        ...
        terms_conditions: (selectedTemplate?.terms_conditions === "null" || selectedTemplate?.terms_conditions == null) ? "" : selectedTemplate.terms_conditions, 

        email_subject: selectedTemplate.email_subject,
        email_body: selectedTemplate.email_body,
        template_name: selectedTemplate.template_name,
        crm_web_hook: (selectedTemplate?.crm_web_hook === "null" || selectedTemplate?.crm_web_hook == null) ? "" : selectedTemplate.crm_web_hook, 
  ...
  const handleEditTemplate = (template) => {
    ...
    setFormData({
      ...
      terms_conditions: (template?.terms_conditions === "null" || template?.terms_conditions == null) ? "" : template.terms_conditions,  // Handle both "null" and null

      email_subject: template?.email_subject,
      email_body: template?.email_body,
      template_name: template?.template_name,
      crm_web_hook: (template?.crm_web_hook === "null" || template?.crm_web_hook == null) ? "" : template.crm_web_hook,  // Handle both "null" and null
    });
