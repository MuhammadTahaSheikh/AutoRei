...
function UserProfile() {
  ...
  const [isCheckedTestMode, setIsCheckedTestMode] = useState(false);
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setIsCheckedTestMode(data.test_mode);
        setId(data.id);
  ...
  const handleCheckboxTestModeChange = () => {
    const newCheckedStateTestMode = !isCheckedTestMode;
    setIsCheckedTestMode(newCheckedStateTestMode);
    const token = localStorage.getItem("accessToken");
    ...
    axios
      .put(
        `/api/notifications/${id}`,
        {
          test_mode: newCheckedStateTestMode,
        },
        {
          headers: {
            Authorization: `Bearer ${token}`,
          ...
          <div className="dashboard-main-container">
            <div className="d-flex flex-row justify-content-between">
              ...
              <div className="d-flex flex-row justify-content-between align-items-center gap-4">
                <p className="noti-text">Test Mode</p>
                <div className="form-check form-switch">
                  <input
                    ...
                    checked={isCheckedTestMode}
                    onChange={handleCheckboxTestModeChange}
                  ></input>
                </div>
              </div>
            </div>
