        ...
        try:
            ...
            response = self.table.put_item(
                Item = {
                    ...
                    'list_price_percent': list_price_percent or None,
                    'offer_expiration_days': offer_expiration_days or None,
                    'closing_days': closing_days or None,
                    'escrow_deposit': escrow_deposit or None,
                    'inspection_period_days': inspection_period_days or None,
                    'terms_conditions': terms_conditions or None,
                    'email_subject': email_subject or None,
                    'email_body': email_body or None,
                    'template_name': template_name or None,
                    'save_filter': save_filter or None,
                    'crm_web_hook': crm_web_hook or None,
                    'earnest_money_deposit': earnest_money_deposit or None,
